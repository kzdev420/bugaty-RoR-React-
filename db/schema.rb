...
ActiveRecord::Schema.define(version: 20200302104008) do
  ...
  create_table "help_center_sections", force: :cascade do |t|
    t.string   "background"
    t.string   "title"
    t.string   "mini_title"
    t.string   "title_1"
  ...
  create_table "membership_landingpage_fifth_sections", force: :cascade do |t|
    t.string   "background"
    t.string   "title"
    t.text     "description"
    t.datetime "created_at",  null: false
  ...
  create_table "membership_landingpage_first_sections", force: :cascade do |t|
    t.string   "title"
  ...
  create_table "membership_landingpage_fourth_sections", force: :cascade do |t|
    t.string   "background"
    t.string   "title"
    t.string   "mini_title"
    t.text     "description"
  ...
  create_table "membership_landingpage_second_sections", force: :cascade do |t|
    t.string   "image"
    t.string   "title"
  ...
  create_table "membership_landingpage_sixth_sections", force: :cascade do |t|
    t.string   "background"
    t.string   "title"
    t.text     "description"
    t.string   "button_title"
  ...
  create_table "membership_landingpage_third_sections", force: :cascade do |t|
    t.string   "title"
    t.text     "description"
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
  ...
  create_table "membership_plan_portfolios", force: :cascade do |t|
    t.string   "image"
    t.string   "title"
    t.text     "description"
    t.datetime "created_at",  null: false
  ...
  create_table "membership_plan_questions", force: :cascade do |t|
    t.string   "question"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  create_table "membership_plan_testimonials", force: :cascade do |t|
    t.string   "image"
    t.string   "title"
    t.text     "description"
    t.datetime "created_at",  null: false
  ...
  create_table "my_shop_sections", force: :cascade do |t|
    t.string   "image"
  ...
  create_table "subscription_portfolios", force: :cascade do |t|
    t.string   "background"
    t.string   "title"
    t.string   "title_1"
    t.string   "image_1"
