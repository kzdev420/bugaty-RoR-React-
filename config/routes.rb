Rails.application.routes.draw do
  ...
  get '/memberships/plans' => "memberships#plans"
  get '/memberships/change' => "memberships#change_plan"
  get '/memberships/pay' => "memberships#pay"
  ...
  get '/about/founders' => "statics#founders"
  ...
  get 'support/' => "support_topics#support_search", as: :support_search
  post 'support/search' => "support_topics#support_search"
  patch 'support/search' => "support_topics#support_search"
  get 'support/general' => "support_topics#bugaty_legal"
  get 'support/general/:support_general_article_slug' => "support_topics#bugaty_legal_article", as: :slugged_support_general_article
